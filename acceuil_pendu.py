...
dictionnaire_scores = lire_fichier_scores()
    ...
    # Afficher le tableau
def mise_en_forme_tableau(dictionnaire) :
    chaine = [f"{nom}: {valeur}" for nom, valeur in dictionnaire.items()]
    return "\n".join(chaine)

chaine_scores = mise_en_forme_tableau(dictionnaire_scores)
...
def action_bouton_score():
    ...
    font_tableau_score = pygame.font.Font(None,40)
    tableau_scores = font_tableau_score.render(chaine_scores, True, (0,0,0))
    ecran.blit(tableau_scores,(350,150))
